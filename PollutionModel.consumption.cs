...
namespace Environmental_Monitoring
{
    ...
    {
        /// <summary>
        /// model input class for PollutionModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for PollutionModel.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Value_LB")]
            public float[] Value_LB { get; set; }

            [ColumnName(@"Value_UB")]
            public float[] Value_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Github\CNPM-Environment-App\PollutionModel.mlnet");
