...
{
    public partial class PollutionModel
    {
        public const string RetrainFilePath =  @"C:\Github\pollution_training.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:3,seriesLength:21,trainSize:72,horizon:6,outputColumnName:@"Value",inputColumnName:@"Value",confidenceLowerBoundColumn:@"Value_LB",confidenceUpperBoundColumn:@"Value_UB");
